...
from msp.optimizer.globalopt.rmc import BasinHoppingASE, BasinHoppingBatch
...
predictor_batch = BasinHoppingBatch(forcefield, hops=10, steps=100, dr=0.1, optimizer='Adam', batch_size=32)
...
for i in range(0, max_iterations):
    ...
    # total_list, minima_list = predictor_batch.predict(initial_structures)
    ...
    total_list_batch, minima_list_batch, energies, accepts, accept_rate, temps, step_sizes = predictor_batch.predict(initial_structures, objective_func, batch_size=32)
